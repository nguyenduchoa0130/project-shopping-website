...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT."/public/user/css/header-style.css"; ?>">
    <link rel="stylesheet" href="<?php echo ROOT."/public/user/css/main-content-style.css"; ?>">
    <link rel="stylesheet" href="<?php echo ROOT."/public/user/css/product-style.css"; ?>">
</head>

<body class="w-100" id="page-top" style="-webkit-text-size-adjust: auto; text-size-adjust: auto;">
