                ...
                <?php foreach ($data as $item) : ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="#" class="btn btn-success" data-toggle="modal" data-username="<?php echo $account->username; ?>" data-target="#account-notification"><i class="fas fa-id-card"></i></a>
                            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#account-notification"><i class="fas fa-tools"></i></a>
