            ...
            $rows .=
                ...
                if($status->status_code == 1){
                    ...
                    <td class='text-center'>
                        <button class='btn btn-success btn-order-detail' date-date='$order->date_created' data-id='$order->id_order' data-toggle='modal' data-target='#order-complete'><i class='fas fa-calendar-week'></i></button>
                    </td>
                </tr>
                ";
