...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Lập Trình Web 1</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<script src="/project-shopping-website/public/admin/vendor/jquery/jquery.min.js"></script>
<script src="/project-shopping-website/public/admin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

<!-- Core plugin JavaScript-->
<script src="/project-shopping-website/public/admin/vendor/jquery-easing/jquery.easing.min.js"></script>

<!-- Custom scripts for all pages-->
<script src="/project-shopping-website/public/admin/js/sb-admin-2.min.js"></script>
